    ...
    return(
        <form id={form.id} onSubmit={form.onSubmit} action={action}>
            <div className="flex items-center gap-x-4">
                ...
                <h1 className="text-xl font-semibold tracking-tight">Nouvelle banniere</h1>
            </div>

            <Card className="mt-5">
                <CardHeader>
                    <CardTitle>Détails de la bannière</CardTitle>
                    <CardDescription>Créer une bannière ici</CardDescription>
                </CardHeader>
                    ...
                    <div className="flex flex-col gap-y-6">
                        <div className="flex flex-col gap-3">
                            ...
                            <Input name={fields.title.name}
                                ...
                                type="text"
                                placeholder="Créer un titre pour la Bannière"/>
                        </div>
                ...
                <CardFooter>
                    <SubmitButton text="Créer une bannière"/>
                </CardFooter>
            </Card>
        </form>
    )
