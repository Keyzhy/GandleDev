...
export function ProductCard({ item }: iAppProps) {
    return (
        <div className="rounded-2xl w-full md:w-64 lg:w-72 xl:w-80 h-auto mt-3 relative bg-white shadow-lg">
            ...
            <Link href={`/product/${item.id}`}>
                <div className="flex justify-between items-center mt-2">
                    ...
                    <h3 className="inline-flex items-center rounded-md bg-[]/10 px-2 py-1 text-s font-medium text-primary ring-1 ring-primary/10">
                        {item.price} €
                    </h3>
                </div>
